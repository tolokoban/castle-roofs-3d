require( 'step005', function(exports, module) {  "use strict";
var Lights = require("lights");
var Castles = require("castles");
var MeshFactory = require("mesh-factory-005");
...
var Step003 = function( args ) {
    ...
    var meshWall = new MeshFactory(new THREE.MeshStandardMaterial({
        metalness: 0,
        roughness: .7,
        map: texWall,
        bumpMap: texWallBump
    ...
    var meshRoof = new MeshFactory(new THREE.MeshStandardMaterial({
        metalness: 0,
        roughness: .5,
        map: texGrass,
    ...
    grp.add( meshWall.toMesh(), meshRoof.toMesh() );
